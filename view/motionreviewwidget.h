#ifndef MOTIONREVIEWWIDGET_H
#define MOTIONREVIEWWIDGET_H
...
class MotionReviewWidget : public QWidget
{
    Q_OBJECT
private:
    QDateEdit *dateEdit;
...
public:
    explicit MotionReviewWidget(QWidget *parent = nullptr);
    void create_widget();
